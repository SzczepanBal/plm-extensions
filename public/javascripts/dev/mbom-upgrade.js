...
function setUIEvents() {
    ...
    $('#mode-disassemble').click(function() { 
        ...
        $('body').addClass('mode-disassemble').removeClass('mode-ebom').removeClass('mode-add').removeClass('mode-instructions').removeClass('mode-erp');
        setTimeout(function() { 
            viewer.resize(); 
    ...
    $('#mode-ebom').click(function() { 
        $('body').removeClass('mode-disassemble').addClass('mode-ebom').removeClass('mode-add').removeClass('mode-instructions').removeClass('mode-erp');
    ...
    $('#mode-add').click(function() { 
        $('body').removeClass('mode-disassemble').removeClass('mode-ebom').addClass('mode-add').removeClass('mode-instructions').removeClass('mode-erp');
        setTimeout(function() { viewer.resize(); }, 250); 
        disassembleMode = false;
        $(this).addClass('selected');
        $(this).siblings().removeClass('selected');
    ...
    $('#mode-instructions').click(function() { 
        $('body').removeClass('mode-disassemble').removeClass('mode-ebom').removeClass('mode-add').addClass('mode-instructions').removeClass('mode-erp');
        setTimeout(function() { viewer.resize(); }, 250); 
        disassembleMode = false;
        $(this).addClass('selected');
        $(this).siblings().removeClass('selected');
