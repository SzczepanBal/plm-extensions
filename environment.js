...
// ---------------------------------------------------------------------------------------------------------------------------
//  OPTIONAL ERP SETTINGS
// ---------------------------------------------------------------------------------------------------------------------------
//  Use these settings for custom ERP proxy endpoints in routes/plm.js.
//  The values can also be provided through environment variables and will then override this file.
exports.erp = {
    baseUrl       : '',
    integrationId : '',
    username      : '',
